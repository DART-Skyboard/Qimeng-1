...
if(len(sys.argv)<=1):
	...
	zi = sys.argv[1];
f = open("../../result/demo_functions/plot/Plot_BDD_"+str(zi)+".py","w");
f.write("import	matplotlib.pyplot as plt\n\n");

f_verilog = open("../../result/demo_functions/rtl/function_"+str(zi)+"_BDD_number_0.v","r")
...
print("finish generate"+" result/demo_functions/plot/Plot_BDD_"+str(zi)+".py")
