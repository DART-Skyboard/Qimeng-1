...
cd	/lustre/S/chengshuyao/Chip_Learning_tape_out_debug_v3_a
...
#####  #Do your stuff here
#####  source /lustre/S/chengshuyao/pyt1.5/bin/activate
#####  cd /lustre/S/chengshuyao/Chip_Learning_RISCV_CPU_10_print/
#####  #python start.py $run $run
#####  bash zstart.sh $run $run
#####done
