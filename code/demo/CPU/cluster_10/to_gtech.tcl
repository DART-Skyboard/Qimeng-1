...
for {set i 0} {$i < 1826} {incr i} {
	read_verilog -rtl ../../../result/CPU/cluster_10/rtl/module_output_bit_$i.v
	...
	write -f verilog -hierarchy -output ../../../result/CPU/cluster_10/gtech/module_output_bit_$i.v
...
#}
	...
	write -f verilog -hierarchy -output ../../../result/CPU/cluster_10/RISCV_train.v
