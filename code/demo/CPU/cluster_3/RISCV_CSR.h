...
void RISCV_CSR(bool input_data[bit_width], bool* output_data) {
	...
	bool S_software_interrupt = (csr[number_mip][31-3] && csr[number_mie][31-3] && csr[number_mideleg][31-3]==1 && number_this_priviledge!=3 && (number_this_priviledge<1 || csr[number_mstatus][31-1]==1)) || (csr[number_mip][31-1] && csr[number_mie][31-1] && number_this_priviledge!=3 && (number_this_priviledge<1 || csr[number_mstatus][31-1]==1));
	bool S_timer_interrupt = (csr[number_mip][31-7] && csr[number_mie][31-7] && csr[number_mideleg][31-7]==1 && number_this_priviledge!=3 && (number_this_priviledge<1 || csr[number_mstatus][31-1]==1)) || (csr[number_mip][31-5] && csr[number_mie][31-5] && number_this_priviledge!=3 && (number_this_priviledge<1 || csr[number_mstatus][31-1]==1));
	/*这里还需要讨论下*/
	...
	bool S_external_interrupt = (csr[number_mip][31-11] && csr[number_mie][31-11] && csr[number_mideleg][31-11]==1 && (number_this_priviledge<3 || csr[number_mstatus][31-3]==1)) || (csr[number_mip][31-9] && csr[number_mie][31-9] && number_this_priviledge!=3 && (number_this_priviledge<1 || csr[number_mstatus][31-1]==1)); // || (csr[number_sstatus][31-1]==true && csr[number_sie][31-9] == true && csr[number_sip][31-9] == true);
