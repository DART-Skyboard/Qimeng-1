...
for {set i 0} {$i < 1826} {incr i} {
	read_verilog -rtl ../../../result/CPU/cluster_8/rtl/module_output_bit_$i.v
	...
	write -f verilog -hierarchy -output ../../../result/CPU/cluster_8/gtech/module_output_bit_$i.v
...
#}
	...
	write -f verilog -hierarchy -output ../../../result/CPU/cluster_8/RISCV_train.v
